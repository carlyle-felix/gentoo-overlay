...
IUSE="debug elogind +gnome-online-accounts +ibus input_devices_wacom kerberos +geolocation networkmanager systemd test wayland"
REQUIRED_USE="
	^^ ( elogind systemd )
...
DEPEND="
	...
	>=gnome-base/gnome-settings-daemon-49.0[colord]
